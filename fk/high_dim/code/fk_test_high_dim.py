...
if __name__ == '__main__':
    ...
    #ep = torch.arange(18)
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_cnn_loss_var.npy', 'wb') as f:
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_gir_loss_var.npy', 'wb') as f:
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_don_loss_var.npy', 'wb') as f:
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_cnn_time_var.npy', 'wb') as f:
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_gir_time_var.npy', 'wb') as f:
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_don_time_var.npy', 'wb') as f:
        ...
        with open('/scratch/xx84/girsanov/fk/high_dim/result/'+str(dim)+'_em_time_var.npy', 'wb') as f:
