...
class FKModule(pl.LightningModule):
    def __init__(self, N = 2000, lr = 1e-3, X = 1., T = 0.1, dim = 2, batch_size = 100, num_time = 100, n_batch_val=100):
        ...
        self.model = TFNO(n_modes=(16, 16), hidden_channels=32, projection_channels=64, factorization='tucker', rank=0.42)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        plt.clf()
        torch.save(self.expmart_cnn.state_dict(), '/scratch/xx84/girsanov/fk/high_dim/trained_model/tfno_'+str(self.dim)+'.pt')
