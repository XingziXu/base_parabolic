...
ax[0,1].plot(ep, np.array(gir_mean), label='GIR', color='darkorange')
ax[0,1].fill_between(ep, np.array(gir_mean-gir_var), np.array(gir_mean+gir_var), alpha=0.2, color='darkorange')
ax[0,1].plot(ep, np.array(em_mean), label='E-M', color='tomato')
ax[0,1].fill_between(ep, np.array(em_mean-em_var), np.array(em_mean+em_var), alpha=0.2, color='tomato')
ax[0,1].plot(ep, np.array(cnn_mean), label='NGO', color='teal')
ax[0,1].fill_between(ep, np.array(cnn_mean-cnn_var), np.array(cnn_mean+cnn_var), alpha=0.2, color='teal')
ax[0,1].plot(ep, np.array(don_mean), label='DON',color='slateblue')
...
ax[1,1].plot(ep, np.array(em_mean_t), label='E-M', color='tomato')
ax[1,1].fill_between(ep, np.array(em_mean_t-em_var_t), np.array(em_mean_t+em_var_t), alpha=0.2, color='tomato')
ax[1,1].plot(ep, np.array(cnn_mean_t), label='NGO', color='teal')
ax[1,1].fill_between(ep, np.array(cnn_mean_t-cnn_var_t), np.array(cnn_mean_t+cnn_var_t), alpha=0.2, color='teal')
ax[1,1].plot(ep, np.array(gir_mean_t), label='GIR', color='darkorange')
ax[1,1].fill_between(ep, np.array(gir_mean_t-gir_var_t), np.array(gir_mean_t+gir_var_t), alpha=0.2, color='darkorange')
#ax[0,1].ylim(0, np.array(don_mean).max()+0.2)
#plt.ylim(0., 1.)
ax[1,1].plot(ep, np.array(don_mean_t), label='DON',color='slateblue')
...
ax[0,2].plot(ep, np.array(gir_mean), label='E-M', color='tomato')
ax[0,2].fill_between(ep, np.array(gir_mean-gir_var), np.array(gir_mean+gir_var), alpha=0.2, color='tomato')
ax[0,2].plot(ep, np.array(cnn_mean), label='NGO', color='teal')
ax[0,2].fill_between(ep, np.array(cnn_mean-cnn_var), np.array(cnn_mean+cnn_var), alpha=0.2, color='teal')
ax[0,2].plot(ep, np.array(don_mean), label='DON',color='slateblue')
ax[0,2].fill_between(ep, np.array(don_mean-don_var), np.array(don_mean+don_var), alpha=0.2,color='slateblue')
#plt.ylim(0, 0.02*1e3)
...
ax[1,2].plot(ep, np.array(cnn_mean_t), label='NGO', color='teal')
ax[1,2].fill_between(ep, np.array(cnn_mean_t-cnn_var_t), np.array(cnn_mean_t+cnn_var_t), alpha=0.2, color='teal')
ax[1,2].plot(ep, np.array(gir_mean_t), label='E-M', color='tomato')
ax[1,2].fill_between(ep, np.array(gir_mean_t-gir_var_t), np.array(gir_mean_t+gir_var_t), alpha=0.2, color='tomato')
#ax[0,1].ylim(0, np.array(don_mean).max()+0.2)
#plt.ylim(0., 1.)
ax[1,2].plot(ep, np.array(don_mean_t), label='DON',color='slateblue')
ax[1,2].fill_between(ep, np.array(don_mean_t-don_var_t), np.array(don_mean_t+don_var_t), alpha=0.2,color='slateblue')
