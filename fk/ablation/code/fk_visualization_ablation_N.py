...
plt.legend()
plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/N_time_fk.pdf')
plt.clf()
...
plt.xlabel('Number of Samples')
plt.legend()
plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/N_loss_fk.pdf')
plt.clf()
...
plt.xlabel('Number of Samples')
plt.legend()
plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/N_time_ou_fk.pdf')
plt.clf()
...
plt.ylim(0, np.array(don_min).max()+0.2)
#plt.ylim(0., 1.)
plt.plot(ep, np.array(don_mean), label='DeepONet',color='darkslateblue')
...
plt.xlabel('Number of Samples')
plt.legend()
plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/N_loss_ou_fk.pdf')
plt.clf()