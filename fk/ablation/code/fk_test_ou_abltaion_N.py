...
if __name__ == '__main__':
    ...
    #ep = torch.arange(18)
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_loss_min.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_loss_max.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_loss_var.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_var))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_loss_min.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_loss_max.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_loss_var.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_var))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(don_loss_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_loss_min.npy', 'wb') as f:
            np.save(f, np.array(don_loss_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_loss_max.npy', 'wb') as f:
            np.save(f, np.array(don_loss_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_loss_var.npy', 'wb') as f:
            np.save(f, np.array(don_loss_var))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(em_loss_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_loss_min.npy', 'wb') as f:
            np.save(f, np.array(em_loss_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_loss_max.npy', 'wb') as f:
            np.save(f, np.array(em_loss_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_loss_var.npy', 'wb') as f:
            np.save(f, np.array(em_loss_var))
        
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_time_mean.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_time_min.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_time_max.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_cnn_time_var.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_var))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_time_mean.npy', 'wb') as f:
            np.save(f, np.array(gir_time_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_time_min.npy', 'wb') as f:
            np.save(f, np.array(gir_time_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_time_max.npy', 'wb') as f:
            np.save(f, np.array(gir_time_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_gir_time_var.npy', 'wb') as f:
            np.save(f, np.array(gir_time_var))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_time_mean.npy', 'wb') as f:
            np.save(f, np.array(don_time_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_time_min.npy', 'wb') as f:
            np.save(f, np.array(don_time_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_time_max.npy', 'wb') as f:
            np.save(f, np.array(don_time_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_don_time_var.npy', 'wb') as f:
            np.save(f, np.array(don_time_var))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_time_mean.npy', 'wb') as f:
            np.save(f, np.array(em_time_mean))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_time_min.npy', 'wb') as f:
            np.save(f, np.array(em_time_min))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_time_max.npy', 'wb') as f:
            np.save(f, np.array(em_time_max))
        with open('/scratch/xx84/girsanov/fk/ablation/result_N/dim_ou_em_time_var.npy', 'wb') as f:
