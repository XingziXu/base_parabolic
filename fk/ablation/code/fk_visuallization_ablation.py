...
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_ou_em_loss_mean.npy', 'rb') as f:
    ou_em_mean = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_ou_em_loss_min.npy', 'rb') as f:
    ou_em_min = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_ou_em_loss_max.npy', 'rb') as f:
    ou_em_max = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_ou_em_loss_var.npy', 'rb') as f:
...
ep = (torch.arange(len(ou_gir_mean))+1) 
...
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_loss_mean.npy', 'rb') as f:
    bs_cnn_mean = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_loss_min.npy', 'rb') as f:
    bs_cnn_min = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_loss_max.npy', 'rb') as f:
    bs_cnn_max = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_loss_var.npy', 'rb') as f:
    bs_cnn_var = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_loss_mean.npy', 'rb') as f:
    bs_don_mean = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_loss_min.npy', 'rb') as f:
    bs_don_min = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_loss_max.npy', 'rb') as f:
    bs_don_max = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_loss_var.npy', 'rb') as f:
    bs_don_var = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_loss_mean.npy', 'rb') as f:
    bs_em_mean = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_loss_min.npy', 'rb') as f:
    bs_em_min = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_loss_max.npy', 'rb') as f:
    bs_em_max = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_loss_var.npy', 'rb') as f:
...
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_time_mean.npy', 'rb') as f:
    bs_cnn_mean_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_time_min.npy', 'rb') as f:
    bs_cnn_min_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_time_max.npy', 'rb') as f:
    bs_cnn_max_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_cnn_time_var.npy', 'rb') as f:
    bs_cnn_var_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_time_mean.npy', 'rb') as f:
    bs_don_mean_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_time_min.npy', 'rb') as f:
    bs_don_min_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_time_max.npy', 'rb') as f:
    bs_don_max_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_don_time_var.npy', 'rb') as f:
    bs_don_var_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_time_mean.npy', 'rb') as f:
    bs_em_mean_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_time_min.npy', 'rb') as f:
    bs_em_min_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_time_max.npy', 'rb') as f:
    bs_em_max_t = torch.Tensor(np.load(f))
with open('/scratch/xx84/girsanov/fk/ablation/result/dim_bs_em_time_var.npy', 'rb') as f:
...
plt.tight_layout()
plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure/dim_time_loss_fk.png')
plt.clf()