...
class FKModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        plt.xlabel('Epochs')
        plt.legend()
        plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/ngo_train_girloss_full_'+str(self.N)+'.png')
        plt.clf()
        plt.plot(ep, self.cnn_metrics.mean(-1), label='CNN')
        plt.fill_between(ep, self.cnn_metrics.mean(-1) - self.cnn_metrics.std(-1), self.cnn_metrics.mean(-1) + self.cnn_metrics.std(-1), alpha=0.2)
        plt.ylabel('Relative Error')
        plt.xlabel('Epochs')
        plt.legend()
        plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/ngo_train_girloss_ngo_'+str(self.N)+'.png')
        plt.clf()
        ...
        plt.xlabel('Epochs')
        plt.legend()
        plt.savefig('/scratch/xx84/girsanov/fk/ablation/figure_N/ngo_train_comptime_'+str(self.N)+'.png')
        plt.clf()
        torch.save(self.expmart_cnn.state_dict(), '/scratch/xx84/girsanov/fk/ablation/trained_model_N/ngo_'+str(self.N)+'.pt')
