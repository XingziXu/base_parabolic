...
if __name__ == '__main__':
    ...
    for i in range(1,19):
        ...
        don_min.append(trainer.logged_metrics['rnn_time_min'].item())
        don_mean.append(trainer.logged_metrics['rnn_time_mean'].item())
        don_max.append(trainer.logged_metrics['rnn_time_max'].item())
