...
class FKModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('em_time_min', self.comp_time[np.where(self.comp_time!=0)].min())
        self.log('em_time_mean', self.comp_time[np.where(self.comp_time!=0)].mean())
        self.log('em_time_max', self.comp_time[np.where(self.comp_time!=0)].max())
        ...
        self.log('rnn_time_min', self.rnn_comp_time[np.where(self.rnn_comp_time!=0)].min())
        self.log('rnn_time_mean', self.rnn_comp_time[np.where(self.rnn_comp_time!=0)].mean())
        self.log('rnn_time_max', self.rnn_comp_time[np.where(self.rnn_comp_time!=0)].max())
...
if __name__ == '__main__':
    ...
    for i in reversed(range(1,19)):
        ...
        em_min.append(trainer.logged_metrics['em_time_min'].item())
        em_mean.append(trainer.logged_metrics['em_time_mean'].item())
        em_max.append(trainer.logged_metrics['em_time_max'].item())
        gir_min.append(trainer.logged_metrics['gir_time_min'].item())
        gir_mean.append(trainer.logged_metrics['gir_time_mean'].item())
        gir_max.append(trainer.logged_metrics['gir_time_max'].item())
        cnn_min.append(trainer.logged_metrics['rnn_time_min'].item())
        cnn_mean.append(trainer.logged_metrics['rnn_time_mean'].item())
        cnn_max.append(trainer.logged_metrics['rnn_time_max'].item())
