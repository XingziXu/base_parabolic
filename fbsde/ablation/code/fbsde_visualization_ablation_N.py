...
ax[0,0].set_yscale('log')
ax[0,0].plot(ep, np.array(gir_min), label='GIR', color='darkorange', lw=3, linestyle='dotted')
ax[0,0].fill_between(ep, np.array(gir_min-gir_var), np.array(gir_min+gir_var), alpha=0.2, color='darkorange')
