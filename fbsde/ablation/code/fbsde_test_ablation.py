...
class FKModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.branch.load_state_dict(torch.load('/scratch/xx84/girsanov/fbsde/ablation/trained_model/branch_14d.pt'))
        self.trunk.load_state_dict(torch.load('/scratch/xx84/girsanov/fbsde/ablation/trained_model/trunk_14d.pt'))
        self.expmart_cnn.load_state_dict(torch.load('/scratch/xx84/girsanov/fbsde/ablation/trained_model/exp_cnn_14d.pt'))
        self.zt_cnn.load_state_dict(torch.load('/scratch/xx84/girsanov/fbsde/ablation/trained_model/zt_cnn_14d.pt'))
...
if __name__ == '__main__':
    ...
    for i in range(1,20):
        ...
        #ep = torch.arange(18)
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_cnn_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_cnn_loss_min.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_cnn_loss_max.npy', 'wb') as f:
            np.save(f, np.array(cnn_loss_max))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_gir_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_gir_loss_min.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_gir_loss_max.npy', 'wb') as f:
            np.save(f, np.array(gir_loss_max))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_don_loss_mean.npy', 'wb') as f:
            np.save(f, np.array(don_loss_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_don_loss_min.npy', 'wb') as f:
            np.save(f, np.array(don_loss_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_don_loss_max.npy', 'wb') as f:
            np.save(f, np.array(don_loss_max))
        
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_cnn_time_mean.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_cnn_time_min.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_cnn_time_max.npy', 'wb') as f:
            np.save(f, np.array(cnn_time_max))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_gir_time_mean.npy', 'wb') as f:
            np.save(f, np.array(gir_time_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_gir_time_min.npy', 'wb') as f:
            np.save(f, np.array(gir_time_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_gir_time_max.npy', 'wb') as f:
            np.save(f, np.array(gir_time_max))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_don_time_mean.npy', 'wb') as f:
            np.save(f, np.array(don_time_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_don_time_min.npy', 'wb') as f:
            np.save(f, np.array(don_time_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_don_time_max.npy', 'wb') as f:
            np.save(f, np.array(don_time_max))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_em_time_mean.npy', 'wb') as f:
            np.save(f, np.array(em_time_mean))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_em_time_min.npy', 'wb') as f:
            np.save(f, np.array(em_time_min))
        with open('/scratch/xx84/girsanov/fbsde/ablation/result/14_em_time_max.npy', 'wb') as f:
