...
class FKModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        plt.xlabel('Epochs')
        plt.legend()
        plt.savefig('/scratch/xx84/girsanov/fbsde/high_dim/figure/ngo_train_girloss_full_'+str(self.dim)+'.png')
        plt.clf()
        plt.plot(ep, self.metrics.mean(-1), label='CNN')
        plt.fill_between(ep, self.metrics.mean(-1) - self.metrics.std(-1), self.metrics.mean(-1) + self.metrics.std(-1), alpha=0.2)
        plt.ylabel('Relative Error')
        plt.xlabel('Epochs')
        plt.legend()
        plt.savefig('/scratch/xx84/girsanov/fbsde/high_dim/figure/ngo_train_girloss_ngo_'+str(self.dim)+'.png')
        plt.clf()
        ...
        plt.xlabel('Epochs')
        plt.legend()
        plt.savefig('/scratch/xx84/girsanov/fbsde/high_dim/figure/ngo_train_comptime_'+str(self.dim)+'.png')
        plt.clf()
        torch.save(self.expmart_cnn.state_dict(), '/scratch/xx84/girsanov/fbsde/high_dim/trained_model/exp_cnn_'+str(self.dim)+'.pt')
        torch.save(self.zt_cnn.state_dict(), '/scratch/xx84/girsanov/fbsde/high_dim/trained_model/zt_cnn_'+str(self.dim)+'.pt')
