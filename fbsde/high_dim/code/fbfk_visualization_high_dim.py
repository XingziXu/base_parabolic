...
ax[0,1].plot(ep, np.array(don_mean), label='DeepONet',color='slateblue')
ax[0,1].fill_between(ep, np.array(don_mean-don_var), np.array(don_mean+don_var), alpha=0.2,color='slateblue')
ax[0,1].plot(ep, np.array(gir_mean), label='Girsanov',color='darkorange')
...
ax[1,0].grid()
ax[1,0].set_ylabel('Inference time', labelpad=-2)
...
ax[0,0].plot(ep, np.array(don_mean), label='DeepONet',color='slateblue')
ax[0,0].fill_between(ep, np.array(don_mean-don_var), np.array(don_mean+don_var), alpha=0.2,color='slateblue')
ax[0,0].plot(ep, np.array(gir_mean), label='Girsanov',color='darkorange')
