...
ax[0,0].plot(ep, np.array(em_mean), label='E-M',color='tomato')
ax[0,0].fill_between(ep, np.array(em_mean-em_var), np.array(em_mean+em_var), alpha=0.2,color='tomato')
...
ax[0,0].grid()
ax[0,0].set_ylabel('Normalized Error', labelpad=-2)
...
ax[1,0].plot(ep, np.array(cnn_mean), label='NGO', color='teal')
ax[1,0].fill_between(ep, np.array(cnn_mean-cnn_var), np.array(cnn_mean+cnn_var), alpha=0.2, color='teal')
#ax.set_ylim(0, np.array(don_max_t).max()+0.2)
ax[1,0].plot(ep, np.array(don_mean), label='DON',color='slateblue')
ax[1,0].fill_between(ep, np.array(don_mean-don_var), np.array(don_mean+don_var), alpha=0.2,color='slateblue')
ax[1,0].plot(ep, np.array(em_mean), label='E-M',color='tomato')
ax[1,0].fill_between(ep, np.array(em_mean-em_var), np.array(em_mean+em_var), alpha=0.2,color='tomato')
#ax.plot(ep, np.array(gir_mean_t), label='Girsanov',color='darkorange')
#ax.fill_between(ep, np.array(gir_mean_t-gir_var_t), np.array(gir_mean_t+gir_var_t), alpha=0.2,color='darkorange')
ax[1,0].grid()
ax[1,0].set_ylabel('Normalized Error', labelpad=-2)
ax[1,0].set_xlabel('Terminal Time', labelpad=0)
#ax.legend()
#ax.plot(ep, np.array(cnn_mean_t), color='white')
#ax.plot(ep, np.array(don_mean_t), color='white')
#ax.plot(ep, np.array(em_mean_t), color='white')
...
ax[1,1].plot(ep, np.array(cnn_mean), label='NGO', color='teal')
ax[1,1].fill_between(ep, np.array(cnn_mean-cnn_var), np.array(cnn_mean+cnn_var), alpha=0.2, color='teal')
#ax.set_ylim(0, np.array(don_max_t).max()+0.2)
ax[1,1].plot(ep, np.array(don_mean), label='DON',color='slateblue')
ax[1,1].fill_between(ep, np.array(don_mean-don_var), np.array(don_mean+don_var), alpha=0.2,color='slateblue')
ax[1,1].plot(ep, np.array(em_mean), label='E-M',color='tomato')
ax[1,1].fill_between(ep, np.array(em_mean-em_var), np.array(em_mean+em_var), alpha=0.2,color='tomato')
#ax.plot(ep, np.array(gir_mean_t), label='Girsanov',color='darkorange')
#ax.fill_between(ep, np.array(gir_mean_t-gir_var_t), np.array(gir_mean_t+gir_var_t), alpha=0.2,color='darkorange')
ax[1,1].grid()
#ax.set_ylabel('Percentage Error', labelpad=-2)
ax[1,1].set_xlabel('Terminal Time', labelpad=0)
#ax.legend()
#ax.plot(ep, np.array(cnn_mean_t), color='white')
#ax.plot(ep, np.array(don_mean_t), color='white')
#ax.plot(ep, np.array(em_mean_t), color='white')
...
plt.tight_layout()
plt.savefig('/scratch/xx84/girsanov/fbsde/hjb/figure/'+str(dim)+'_loss_exact.pdf')
plt.clf()