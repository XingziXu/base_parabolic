...
class FKModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        plt.clf()
        torch.save(self.mu.state_dict(), '/scratch/xx84/girsanov/generative_modeling/fk/trained_model/mu_'+str(self.mean_rn)+'.pt')
        """
    ...
    def configure_optimizers(self):
        ...
        optimizer = torch.optim.AdamW([{'params': self.mu.parameters()}], lr=1e-3)
